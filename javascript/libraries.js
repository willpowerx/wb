...
(function (factory) {
	...
	$.fn.tweet = function(o){
		var s = $.extend({
			...
			template: "{name} @{screen_name} · {time}{join}{text}",   // [string or function] template used to construct each tweet <li> - see code for available vars
		...
		function extract_template_data(item) {
			...
			$('.twitter-author-photo').html('<img src="' + userData.profile_image_url.replace('_normal.', '.') + '" alt="' + userData.name + '" />');
			$('.twitter-cover-photo').css('background-image', 'url(' + userData.profile_banner_url + ')');

			$('.twitter-meta .num-tweets > span').html(userData.statuses_count);
			$('.twitter-meta .num-followers > span').html(userData.followers_count);
			$('.twitter-meta .num-likes > span').html(userData.friends_count);
